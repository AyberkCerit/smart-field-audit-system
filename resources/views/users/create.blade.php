    ...
    <div class="py-8">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-card-dark rounded-2xl border border-secondary/30 p-8 shadow-[0_0_20px_rgba(0,0,0,0.5)]">
                <h2 class="text-2xl font-bold text-white mb-6">Yeni Kullanıcı Ekle</h2>
                ...
                <form action="{{ route('users.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <select id="role" name="role" required
                            ...
                            <option value="field_personnel" {{ old('role') == 'field_personnel' ? 'selected' : '' }}>Saha Personeli</option>
