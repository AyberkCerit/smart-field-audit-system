    ...
    <div class="w-full mb-6">
        ...
        <div class="bg-card-dark rounded-2xl border border-secondary/30 p-4 mb-8 shadow-md flex items-center gap-4">
            <div class="flex-1 relative">
                ...
                <input type="text" placeholder="Search task title or description..." class="w-full bg-background border border-secondary/30 rounded-xl pl-10 pr-4 py-2.5 text-text focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-colors">
            </div>
